package com.ronllan.websocket;

import cn.hutool.core.util.ObjectUtil;
import com.ronllan.common.utils.JsonUtils;
import com.ronllan.modules.chat.entity.MessageEntity;
import com.ronllan.websocket.Exception.ServiceException;
import com.ronllan.websocket.config.GetHttpSessionConfig;
import com.ronllan.websocket.entity.ClientInfoEntity;
...
public class WebSocketServer {
    ...
    public void sendMessage(Long userId, MessageEntity message) {
        uavWebSocketInfoMap.values().forEach(info -> {
            if (userId.toString().equals(info.getToken())){
